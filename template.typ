#let project(title: "", author: "", school:"", location: "", subject:"", teacher:"", years: "", deadline: "", body) = {
    ...
    set page(paper: "a4", margin: (left: 2.5cm, right: 2.5cm, top: 3.5cm, bottom: 3.5cm))               // paper format
    ...
    text(weight: "bold")["Ich erkläre hiermit, dass ich die Seminararbeit ohne fremde Hilfe angefertigt und nur die im Literaturverzeichnis angeführten Quellen und Hilfsmittel benützt habe."]
